let FilterWarningsPlugin,nodeExternals,theme,languages,brand;_a33‍.w("webpack-filter-warnings-plugin",[["default",["FilterWarningsPlugin"],function(v){FilterWarningsPlugin=v}]]);_a33‍.w("webpack-node-externals",[["default",["nodeExternals"],function(v){nodeExternals=v}]]);_a33‍.w("./config/vuetify.options",[["theme",["theme"],function(v){theme=v}]]);_a33‍.w("./static/lang/languages",[["default",["languages"],function(v){languages=v}]]);_a33‍.w("./static/text/brand",[["default",["brand"],function(v){brand=v}]]);
  ...
  */
  head: {
    ...
    meta: [
      ...
      { property: 'og:site_name', content: 'panpixel.studio' },
      { property: 'og:locale', content: 'en_US' },
      { property: 'og:type', content: 'website' },
      // Twitter
      { property: 'twitter:site', content: 'panpixel.studio' },
      { property: 'twitter:domain', content: 'panpixel.studio' },
